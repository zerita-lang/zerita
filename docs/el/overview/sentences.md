...
έχουν μεν δομή, αλλά δεν είναι μια δομή που ορίζεται από συντακτικούς κανόνες. Μια
περίοδος είναι μια ακολουθία προτάσεων που συνδέονται με λέξεις όπως το "ete" (και).
...
(μπορείς να το κάνεις;), μια περιγραφή της κατάστασης του κόσμου (βρέχει). Μια φράση
είναι μια ακολουθία συνδεδεμένων λέξεων, για παράδειγμα «ο μεγάλος κακός λύκος».
...
Πόσες προτάσεις έχει καθεμία από τις περιόδους; Εάν είναι περισσότερες από μια,
